...
class WebpagesControllerTest < ActionController::TestCase
  ...
  test "should create webpage" do
    assert_difference('Webpage.count') do
      post :create, webpage: { active: @webpage.active, domain: @webpage.domain, title: @webpage.title, url: @webpage.url, user_id: @webpage.user_id }
    end
  ...
  test "should update webpage" do
    put :update, id: @webpage, webpage: { active: @webpage.active, domain: @webpage.domain, title: @webpage.title, url: @webpage.url, user_id: @webpage.user_id }
    assert_redirected_to webpage_path(assigns(:webpage))
  end
